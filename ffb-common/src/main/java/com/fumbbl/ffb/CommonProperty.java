...
public enum CommonProperty {
	...
	SETTING_MARK_ACTING_PLAYER_ACTION("setting.mark.acting.player.action", "Mark acting player action", "Gameplay"),
	...
	SETTING_DIALOG_KEY_DELAY("setting.dialog.keyDelay", "Dialog Key Delay", "Configuration"),
	;
	...
	public static final CommonProperty[] _SAVED_USER_SETTINGS = {SETTING_SOUND_MODE, SETTING_UI_LAYOUT,
		...
		SETTING_MARK_BLITZING_PLAYER, SETTING_MARK_ACTING_PLAYER_ACTION, SETTING_PLAYER_MARKING_TYPE,
		SETTING_SHOW_AUTO_MARKING_DIALOG, SETTING_SWAP_TEAM_COLORS,
