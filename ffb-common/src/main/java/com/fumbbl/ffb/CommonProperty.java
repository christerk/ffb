...
public enum CommonProperty {
    ...
    SETTING_SWAP_MARKING_GRAPHICS("setting.swap.marking.graphics", "Show marking icons", "Graphics"),
    ...
    public static final CommonProperty[] _SAVED_USER_SETTINGS = {SETTING_SOUND_MODE, SETTING_UI_LAYOUT,
            ...
            SETTING_PLAYER_MARKING_TYPE, SETTING_SHOW_AUTO_MARKING_DIALOG, SETTING_SWAP_TEAM_COLORS, SETTING_SWAP_MARKING_GRAPHICS,
