...
public enum GameOptionId implements INamedObject {
	...
	INDUCEMENT_BRIBES_MAX("inducementBribesMax"), INDUCEMENT_BRIBES_REDUCED_MAX("inducementBribesReducedMax"),
	INDUCEMENT_CHEFS_COST("inducementChefsCost"), INDUCEMENT_CHEFS_REDUCED_COST("inducementChefsReducedCost"),
	INDUCEMENT_CHEFS_MAX("inducementChefsMax"), INDUCEMENT_CHEFS_REDUCED_MAX("inducementChefsReducedMax"),
	INDUCEMENT_EXTRA_TRAINING_COST("inducementExtraTrainingCost"), INDUCEMENT_EXTRA_TRAINING_MAX("inducementExtraTrainingMax"),
	INDUCEMENT_IGORS_COST("inducementIgorsCost"), INDUCEMENT_IGORS_MAX("inducementIgorsMax"),
	INDUCEMENT_MORTUARY_ASSISTANTS_COST("inducementMortuaryAssistantsCost"), INDUCEMENT_MORTUARY_ASSISTANTS_MAX("inducementMortuaryAssistantsMax"),
	INDUCEMENT_PLAGUE_DOCTORS_COST("inducementPlagueDoctorsCost"), INDUCEMENT_PLAGUE_DOCTORS_MAX("inducementPlagueDoctorsMax"),
	INDUCEMENT_KEGS_COST("inducementKegsCost"), INDUCEMENT_KEGS_MAX("inducementKegsMax"),
	INDUCEMENT_MASCOT_MAX("inducementMascotMax"), INDUCEMENT_MASCOT_COST("inducementMascotCost"),
	INDUCEMENT_MERCENARIES_EXTRA_COST("inducementMercenariesExtraCost"), INDUCEMENT_MERCENARIES_SKILL_COST("inducementMercenariesSkillCost"),
	...
	INDUCEMENT_RIOTOUS_ROOKIES_COST("inducementRiotousRookiesCost"), INDUCEMENT_RIOTOUS_ROOKIES_MAX("inducementRiotousRookiesMax"),
	INDUCEMENT_STARS_MAX("inducementStarsMax"), INDUCEMENT_STAFF_MAX("inducementStaffMax"),
	INDUCEMENT_WIZARDS_COST("inducementWizardsCost"), INDUCEMENT_WIZARDS_MAX("inducementWizardsMax"),
	INDUCEMENT_BIASED_REF_COST("inducementBiasedRefCost"), INDUCEMENT_BIASED_REF_REDUCED_COST("inducementBiasedRefReducedCost"),
	INDUCEMENT_BIASED_REF_MAX("inducementBiasedRefMax"), INDUCEMENT_BIASED_REF_REDUCED_MAX("inducementBiasedRefReducedMax"),
	...
	INDUCEMENT_DUMMY("inducementDummy"), INDUCEMENT_JOSEF_BUGMAN_COST("inducementJosefBugmanCost"), INDUCEMENT_JOSEF_BUGMAN_MAX("inducementJosefBugmanMax"),
