...
public enum PlayerAction implements INamedObject {
	...
	HAND_OVER_MOVE("handOverMove", 5, "starts a Hand Over Action", IIconProperty.ACTION_HAND_OVER),
	PASS("pass", 7, null),
	PASS_MOVE("passMove", 7, "starts a Pass Action", IIconProperty.ACTION_PASS),
	FOUL("foul", 9, null),
	FOUL_MOVE("foulMove", 9, "starts a Foul Action", IIconProperty.ACTION_FOUL),
	...
	GAZE_MOVE("gazeMove", 15, "starts a Gaze action", IIconProperty.ACTION_GAZE),
	...
	SECURE_THE_BALL("secureTheBall", 48, "secures the ball", IIconProperty.ACTION_SECURE_THE_BALL),
	BREATHE_FIRE("breatheFire", 49, "starts a Breathe Fire action", IIconProperty.ACTION_BREATHE_FIRE),
	CHAINSAW("chainsaw", 50, "starts a Chainsaw action", IIconProperty.ACTION_CHAINSAW),
	STAB("stab", 51, "starts a Stab action", IIconProperty.ACTION_STAB),
	PROJECTILE_VOMIT("projectileVomit", 52, "starts a Projectile Vomit action", IIconProperty.ACTION_VOMIT),
	...
	CHOMP("chomp", 56, "starts a Chomp action", IIconProperty.ACTION_CHOMP),
	PUNT("punt", 57, null),
	PUNT_MOVE("puntMove", 57, "starts a Punt action", IIconProperty.ACTION_PUNT);
