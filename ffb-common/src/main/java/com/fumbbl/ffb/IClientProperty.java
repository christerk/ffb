...
public interface IClientProperty {
	...
	String KEY_PLAYER_ACTION_BREATHE_FIRE = "key.player.action.breatheFire";
	String KEY_PLAYER_ACTION_THEN_I_STARTED_BLASTIN = "key.player.action.thenIStartedBlastin";
