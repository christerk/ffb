...
public class ReportSwoopDirection extends NoDiceReport {
	...
	public ReportSwoopDirection() {
		super();
	}

	public ReportSwoopDirection(Direction pDirection, int pDirectionRoll, String playerId, boolean outOfBounds) {
	...
	public ReportId getId() {
		return ReportId.SWOOP_DIRECTION_ROLL;
	}
...
// transformation
	...
	public IReport transform(IFactorySource source) {
		return new ReportSwoopDirection(direction != null ? direction.transform() : null, getDirectionRoll(), playerId, outOfBounds);
	}
	...
	public ReportSwoopDirection initFrom(IFactorySource source, JsonValue jsonValue) {
