...
public class ReportSwoopPlayer extends NoDiceReport {
	...
	public ReportSwoopPlayer(FieldCoordinate startCoordinate, FieldCoordinate endCoordinate, Direction direction, int distance, boolean outOfBounds) {
	...
	public IReport transform(IFactorySource source) {
		return new ReportSwoopPlayer(FieldCoordinate.transform(getStartCoordinate()),
				FieldCoordinate.transform(getEndCoordinate()), direction.transform(), distance, outOfBounds);
	}
