...
public class ReportDwarfenWisdomRoll implements IReport {

	private String teamId;
	private int amount;
	private int roll;

	public ReportDwarfenWisdomRoll() {
	}

	public ReportDwarfenWisdomRoll(String teamId, int roll, int amount) {
		this.teamId = teamId;
		this.amount = amount;
		this.roll = roll;
	}
	...
	public ReportId getId() {
		return ReportId.DWARFEN_WISDOM_ROLL;
	}
	...
	public IReport transform(IFactorySource source) {
		return new ReportDwarfenWisdomRoll(teamId, roll, amount);
	}
