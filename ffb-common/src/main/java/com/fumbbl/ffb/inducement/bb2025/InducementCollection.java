...
public class InducementCollection extends com.fumbbl.ffb.inducement.InducementCollection {
	private final Set<InducementType> types = new HashSet<InducementType>() {{
		add(new InducementType("teamMascot", "Team Mascot", "Team Mascot", "Team Mascot", GameOptionId.INDUCEMENT_MASCOT_MAX,
				GameOptionId.INDUCEMENT_MASCOT_COST, GameOptionId.INDUCEMENT_MASCOT_COST, true, IIconProperty.RESOURCE_RE_ROLL, Usage.CONDITIONAL_REROLL, Usage.REROLL_CHEERING_FANS));
		...
		add(new InducementType("bloodweiserBabes", "Blitzer's Best Kegs", "Bloodweiser Keg", "Bloodweiser Kegs",
		...
		add(new InducementType("josefBugman", "Josef Bugman", "Josef Bugman", "Josef Bugman",
			...
			IIconProperty.RESOURCE_BLOODWEISER_KEG, Usage.STAFF, Usage.ADD_TO_KO_RECOVERY));
		add(new InducementType("dwarfenWisdom", "Dwarfen Wisdom", "Dwarfen Wisdom", "Dwarfen Wisdom",
			GameOptionId.INDUCEMENT_JOSEF_BUGMAN_MAX, null, null, true, IIconProperty.RESOURCE_BLOODWEISER_KEG,
			Usage.RESETUP_D3_PLAYERS));
