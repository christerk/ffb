...
class BufferedTextReader {
	 ...
	 * [k|l|m|n|o|p|q|r|s|z|u] < buffer before advance ^ fill index
	 *
	 * [k|l|m|n|o|p|q|r|s|z|u] < buffer after advance ^ fill index
	 */
	...
	/*
	 * offset before / after shift v v
	 * [a|b|c|d|e|f|g|h|i|j|k|l|m|n|o|p|q|r|s|t|u|v|w|x|y] < input
	 * [k|l|m|n|o|p|q|r|s|t] < buffer before shift ^ ^ start fill index
	 *
	 * [q|r|s|t|o|p|q|r|s|t] < buffer after shift ^ ^ start fill index
	 *
	 * [q|r|s|t|u|v|w|x|y|t] < buffer after fill ^ ^ start fill index
	 */
	...
	/*
	 * [a|b|c|d|e|f|g|h|i|j|k|l|m|n|o|p|q|r|s|t|u|v|w|x|y] < input
	 * [k|l|m|n|o|p|q|r|s|t] < buffer before expand ^ ^ start fill index
	 *
	 * [k|l|m|n|o|p|q|r|s|t| | | | | | | | | | ] < buffer after expand ^ ^ start
	 * fill index
	 *
	 * [k|l|m|n|o|p|q|r|s|t|u|v|w|x|y| | | | | ] < buffer after fill ^ ^ ^ start
	 * index fill
	 */
	...
	/*
	 * [a|b|c|d|e|f|g|h|i|j|k|l|m|n|o|p|q|r|s|t|u|v|w|x|y] < input
	 * [q|r|s|?|?|?|?|?|?|?] < buffer before fill ^ fill index
	 *
	 * [q|r|s|t|u|v|w|x|y|?] < buffer after fill ^ ^ index fill
	 */
