...
public enum SkillUse implements INamedObject {
	...
	AVOID_PUSH("avoidPush", "to avoid being pushed"), CANCEL_FEND("cancelFend", "to cancel %g opponent's Fend skill"),
	...
	CATCH_BALL("catchBall", "to catch the ball"), STEAL_BALL("stealBall", "to steal the ball"),
