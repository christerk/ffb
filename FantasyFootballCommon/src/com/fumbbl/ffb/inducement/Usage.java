...
public enum Usage {
	ADD_LINEMEN, ADD_CHEERLEADER, ADD_COACH, ADD_TO_ARGUE_ROLL, APOTHECARY, AVOID_BAN, GAME_MODIFICATION, KNOCKOUT_RECOVERY,
	LONER, REGENERATION, REROLL, REROLL_ARGUE, SPELL, SPOT_FOUL, STAR, STEAL_REROLL, UNSPECIFIC;
