...
public enum GameOptionId implements INamedObject {
	...
	INDUCEMENT_IGORS_MAX("inducementIgorsMax"), INDUCEMENT_KEGS_COST("inducementKegsCost"),
	...
	INDUCEMENT_TEMP_CHEERLEADER_MAX("inducementTempCheerleaderMax"), INDUCEMENT_TEMP_CHEERLEADER_COST("inducementTempCheerleaderCost"),
