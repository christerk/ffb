...
public class ReportSolidDefenceRoll implements IReport {

	private String teamId;
	private int amount;
	private int roll;

	public ReportSolidDefenceRoll() {
	}

	public ReportSolidDefenceRoll(String teamId, int roll, int amount) {
		this.teamId = teamId;
		this.amount = amount;
		this.roll = roll;
	}
	...
	public ReportId getId() {
		return ReportId.SOLID_DEFENCE_ROLL;
	}
	...
	public IReport transform(IFactorySource source) {
		return new ReportSolidDefenceRoll(teamId, roll, amount);
	}
