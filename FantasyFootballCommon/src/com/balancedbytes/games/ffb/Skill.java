...
public enum Skill implements INamedObject {
  ...
  MIGHTY_BLOW("Mighty Blow", SkillCategory.STRENGTH),
    ...
    * hand-offor fail to make an interception. In addition, the Strip Ball skill
  ...
  */
   ...
   */
  SWARMING("Swarming", SkillCategory.EXTRAORDINARY),
    /**
    ...
    */
  SWOOP("Swoop", SkillCategory.EXTRAORDINARY),
    /**
