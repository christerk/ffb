...
public class InterceptionModifiers {
  ...
  public static final InterceptionModifier NERVES_OF_STEEL = new InterceptionModifier("Nerves of Steel", 0, false, false);
  public static final InterceptionModifier EXTRA_ARMS = new InterceptionModifier("Extra Arms", -1, false, false);
  public static final InterceptionModifier VERY_LONG_LEGS = new InterceptionModifier("Very Long Legs", -1, false, false);
  ...
  public static final InterceptionModifier DISTURBING_PRESENCES_1 = new InterceptionModifier("1 Disturbing Presence", 1, false, true);
  public static final InterceptionModifier DISTURBING_PRESENCES_2 = new InterceptionModifier("2 Disturbing Presences", 2, false, true);
  public static final InterceptionModifier DISTURBING_PRESENCES_3 = new InterceptionModifier("3 Disturbing Presences", 3, false, true);
  public static final InterceptionModifier DISTURBING_PRESENCES_4 = new InterceptionModifier("4 Disturbing Presences", 4, false, true);
  public static final InterceptionModifier DISTURBING_PRESENCES_5 = new InterceptionModifier("5 Disturbing Presences", 5, false, true);
  public static final InterceptionModifier DISTURBING_PRESENCES_6 = new InterceptionModifier("6 Disturbing Presences", 6, false, true);
  public static final InterceptionModifier DISTURBING_PRESENCES_7 = new InterceptionModifier("7 Disturbing Presences", 7, false, true);
  public static final InterceptionModifier DISTURBING_PRESENCES_8 = new InterceptionModifier("8 Disturbing Presences", 8, false, true);
  public static final InterceptionModifier DISTURBING_PRESENCES_9 = new InterceptionModifier("9 Disturbing Presences", 9, false, true);
  public static final InterceptionModifier DISTURBING_PRESENCES_10 = new InterceptionModifier("10 Disturbing Presences", 10, false, true);
  public static final InterceptionModifier DISTURBING_PRESENCES_11 = new InterceptionModifier("11 Disturbing Presences", 11, false, true);
