...
public enum SeriousInjury implements INamedObject {
	...
	POISONED("Poisoned (MNG)", "Poisoned (Miss next game)", "has been poisoned (Miss next game)",
			"is recovering from being poisoned", false, null);
	...
	private SeriousInjury(String pName, String pButtonText, String pDescription, String pRecovery, boolean pLasting,
