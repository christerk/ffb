...
public class ArmorModifiers {
	...
	public static final  ArmorModifier CLAWS = new ArmorModifier("Claws", 0, false){
	    ...
	    public boolean appliesToContext(ArmorModifierContext context) {
	    	if(context.isStab || context.isFoul || playerHasChainsaw(context.attacker)) { return false; }
	  ...
	  public static final  ArmorModifier  STAKES = new ArmorModifier("Stakes", 1, false){
		    ...
		    public boolean appliesToContext(ArmorModifierContext context) {
		    	...
		    	Team otherTeam = context.game.getTeamHome().hasPlayer(context.defender) ? context.game.getTeamHome() : context.game.getTeamAway();
