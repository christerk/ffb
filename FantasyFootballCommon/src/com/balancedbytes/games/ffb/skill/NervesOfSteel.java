...
public class NervesOfSteel extends Skill {
	...
	public void postConstruct(ModifierDictionary dictionary) {
		...
		registerModifier(new InterceptionModifier("Nerves of Steel", "0 tackle zones due to Nerves of Steel", 0, false, false, dictionary) {
			@Override
			public boolean isModifierIncluded() {
				return true;
			}
		});
		registerModifier(new CatchModifier("Nerves of Steel","0 for tackle zones due to Nerves of Steel",0, false, false, dictionary) {
			@Override
			public boolean isModifierIncluded() {
				return true;
			}
