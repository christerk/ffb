...
public class InterceptionModifierRegistry extends com.balancedbytes.games.ffb.modifiers.InterceptionModifierRegistry {
	...
	public InterceptionModifierRegistry() {
		...
		add(new InterceptionModifier(TACKLEZONES_1, "1 for 1+ Tacklezones", 1, 1, true, false));
		add(new InterceptionModifier(TACKLEZONES_2, "1 for 1+ Tacklezones", 1, 2, true, false));
		add(new InterceptionModifier(TACKLEZONES_3, "1 for 1+ Tacklezones", 1, 3, true, false));
		add(new InterceptionModifier(TACKLEZONES_4, "1 for 1+ Tacklezones", 1, 4, true, false));
		add(new InterceptionModifier(TACKLEZONES_5, "1 for 1+ Tacklezones", 1, 5, true, false));
		add(new InterceptionModifier(TACKLEZONES_6, "1 for 1+ Tacklezones", 1, 6, true, false));
		add(new InterceptionModifier(TACKLEZONES_7, "1 for 1+ Tacklezones", 1, 7, true, false));
		add(new InterceptionModifier(TACKLEZONES_8, "1 for 1+ Tacklezones", 1, 8, true, false));
