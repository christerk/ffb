...
public abstract class CatchModifierCollection extends ModifierCollection<CatchContext, CatchModifier> {
	...
	public CatchModifierCollection() {
		...
		add(new CatchModifier("2 Disturbing Presences", 2, false, true));
		add(new CatchModifier("3 Disturbing Presences", 3, false, true));
		add(new CatchModifier("4 Disturbing Presences", 4, false, true));
		add(new CatchModifier("5 Disturbing Presences", 5, false, true));
		add(new CatchModifier("6 Disturbing Presences", 6, false, true));
		add(new CatchModifier("7 Disturbing Presences", 7, false, true));
		add(new CatchModifier("8 Disturbing Presences", 8, false, true));
		add(new CatchModifier("9 Disturbing Presences", 9, false, true));
		add(new CatchModifier("10 Disturbing Presences", 10, false, true));
		add(new CatchModifier("11 Disturbing Presences", 11, false, true));
