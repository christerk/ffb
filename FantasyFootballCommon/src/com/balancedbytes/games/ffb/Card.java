...
public enum Card implements INamedObject {
	...
	BELT_OF_INVULNERABILITY("Belt of Invulnerability", "Invulnerability Belt", CardType.MAGIC_ITEM, CardTarget.OWN_PLAYER,
	...
	GIKTAS_STRENGTH_OF_DA_BEAR("Gikta's Strength of da Bear", "Gikta's Strength", CardType.MAGIC_ITEM,
	...
	GOOD_OLD_MAGIC_CODPIECE("Good Old Magic Codpiece", "Magic Codpiece", CardType.MAGIC_ITEM, CardTarget.OWN_PLAYER,
