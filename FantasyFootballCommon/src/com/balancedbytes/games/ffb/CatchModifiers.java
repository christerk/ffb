...
public class CatchModifiers {
	...
	public static final CatchModifier DISTURBING_PRESENCES_2 = new CatchModifier("2 Disturbing Presences", 2, false, true);
	public static final CatchModifier DISTURBING_PRESENCES_3 = new CatchModifier("3 Disturbing Presences", 3, false, true);
	public static final CatchModifier DISTURBING_PRESENCES_4 = new CatchModifier("4 Disturbing Presences", 4, false, true);
	public static final CatchModifier DISTURBING_PRESENCES_5 = new CatchModifier("5 Disturbing Presences", 5, false, true);
	public static final CatchModifier DISTURBING_PRESENCES_6 = new CatchModifier("6 Disturbing Presences", 6, false, true);
	public static final CatchModifier DISTURBING_PRESENCES_7 = new CatchModifier("7 Disturbing Presences", 7, false, true);
	public static final CatchModifier DISTURBING_PRESENCES_8 = new CatchModifier("8 Disturbing Presences", 8, false, true);
	public static final CatchModifier DISTURBING_PRESENCES_9 = new CatchModifier("9 Disturbing Presences", 9, false, true);
	public static final CatchModifier DISTURBING_PRESENCES_10 = new CatchModifier("10 Disturbing Presences", 10, false, true);
	...
	public static final CatchModifier DIVING_CATCH = new CatchModifier("Diving Catch", -1, false, false) {
		 @Override
		    public boolean appliesToContext(Skill skill, CatchContext context) {
			 ...
			 if ((CatchScatterThrowInMode.CATCH_ACCURATE_PASS == context.catchMode) || (CatchScatterThrowInMode.CATCH_ACCURATE_BOMB == context.catchMode)) {
				return true;
			 }
			 return false;
