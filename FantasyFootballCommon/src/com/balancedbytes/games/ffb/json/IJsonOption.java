...
public interface IJsonOption {
	...
	JsonEnumWithNameOption ANIMATION_TYPE = new JsonEnumWithNameOption("animationType", Factory.animationType);
	...
	JsonEnumWithNameOption BLOCK_RESULT = new JsonEnumWithNameOption("blockResult", Factory.blockResult);
	...
	JsonEnumWithNameOption CARD_EFFECT = new JsonEnumWithNameOption("cardEffect", Factory.cardEffect);
	...
	JsonEnumWithNameOption CARD_TYPE = new JsonEnumWithNameOption("cardType", Factory.cardType);
	...
	JsonEnumWithNameOption CLIENT_MODE = new JsonEnumWithNameOption("clientMode", Factory.clientMode);
	...
	JsonEnumWithNameOption CLIENT_STATE_ID = new JsonEnumWithNameOption("clientStateId", Factory.clientStateId);
	...
	JsonEnumWithNameOption CONCEDE_GAME_STATUS = new JsonEnumWithNameOption("concedeGameStatus", Factory.concedeGameStatus);
	...
	JsonEnumWithNameOption DEFENDER_ACTION = new JsonEnumWithNameOption("defenderAction", Factory.playerAction);
	...
	JsonEnumWithNameOption DIALOG_ID = new JsonEnumWithNameOption("dialogId", Factory.dialogId);
	...
	JsonEnumWithNameOption GAME_OPTION_ID = new JsonEnumWithNameOption("gameOptionId", Factory.gameOptionId);
	...
	JsonEnumWithNameOption INDUCEMENT_TYPE = new JsonEnumWithNameOption("inducementType", Factory.inducementType);
	...
	JsonEnumWithNameOption INJURY_TYPE = new JsonEnumWithNameOption("injuryType", Factory.injuryType);
	...
	JsonEnumWithNameOption KICKOFF_RESULT = new JsonEnumWithNameOption("kickoffResult", Factory.kickoffResult);
	...
	JsonEnumWithNameOption LAST_TURN_MODE = new JsonEnumWithNameOption("lastTurnMode", Factory.turnMode);
	JsonEnumWithNameOption LEADER_STATE = new JsonEnumWithNameOption("leaderState", Factory.leaderState);
	...
	JsonEnumWithNameOption MODEL_CHANGE_ID = new JsonEnumWithNameOption("modelChangeId", Factory.modelChangeId);
	...
	JsonEnumWithNameOption NET_COMMAND_ID = new JsonEnumWithNameOption("netCommandId", Factory.netCommandId);
	...
	JsonEnumWithNameOption PASSING_DISTANCE = new JsonEnumWithNameOption("passingDistance", Factory.passingDistance);
	...
	JsonEnumWithNameOption PLAYER_ACTION = new JsonEnumWithNameOption("playerAction", Factory.playerAction);
	JsonArrayOption PLAYER_ARRAY = new JsonArrayOption("playerArray");
	JsonIntOption PLAYER_AWARDS = new JsonIntOption("playerAwards");
	JsonEnumWithNameOption PLAYER_CHOICE_MODE = new JsonEnumWithNameOption("playerChoiceMode", Factory.playerChoiceMode);
	...
	JsonEnumWithNameOption PLAYER_GENDER = new JsonEnumWithNameOption("playerGender", Factory.playerGender);
	...
	JsonEnumWithNameOption PLAYER_TYPE = new JsonEnumWithNameOption("playerType", Factory.playerType);
	...
	JsonEnumWithNameOption PUSHBACK_MODE = new JsonEnumWithNameOption("pushbackMode", Factory.pushbackMode);
	...
	JsonEnumWithNameOption RECOVERING_INJURY = new JsonEnumWithNameOption("recoveringInjury", Factory.seriousInjury);
	JsonIntOption REPLAY_TO_COMMAND_NR = new JsonIntOption("replayToCommandNr");
	JsonEnumWithNameOption REPORT_ID = new JsonEnumWithNameOption("reportId", Factory.reportId);
	...
	JsonEnumWithNameOption RE_ROLLED_ACTION = new JsonEnumWithNameOption("reRolledAction", Factory.reRolledAction);
	...
	JsonEnumWithNameOption RE_ROLL_SOURCE = new JsonEnumWithNameOption("reRollSource", Factory.reRollSource);
	...
	JsonEnumWithNameOption SEND_TO_BOX_REASON = new JsonEnumWithNameOption("sendToBoxReason", Factory.sendToBoxReason);
	JsonIntOption SEND_TO_BOX_TURN = new JsonIntOption("sendToBoxTurn");
	JsonEnumWithNameOption SERIOUS_INJURY = new JsonEnumWithNameOption("seriousInjury", Factory.seriousInjury);
	JsonEnumWithNameOption SERIOUS_INJURY_DECAY = new JsonEnumWithNameOption("seriousInjuryDecay", Factory.seriousInjury);
	JsonEnumWithNameOption SERIOUS_INJURY_NEW = new JsonEnumWithNameOption("seriousInjuryNew", Factory.seriousInjury);
	JsonEnumWithNameOption SERIOUS_INJURY_OLD = new JsonEnumWithNameOption("seriousInjuryOld", Factory.seriousInjury);
	JsonIntOption SERIOUS_INJURY_SUFFERED = new JsonIntOption("seriousInjurySuffered");
	JsonEnumWithNameOption SERVER_STATUS = new JsonEnumWithNameOption("serverStatus", Factory.serverStatus);
	...
	JsonEnumWithNameOption SKILL_USE = new JsonEnumWithNameOption("skillUse", Factory.skillUse);
	...
	JsonEnumWithNameOption SOUND = new JsonEnumWithNameOption("sound", Factory.soundId);
	JsonEnumWithNameOption SPECIAL_EFFECT = new JsonEnumWithNameOption("specialEffect", Factory.specialEffect);
	...
	JsonEnumWithNameOption TEAM_STATUS = new JsonEnumWithNameOption("teamStatus", Factory.teamStatus);
	...
	JsonEnumWithNameOption THROWER_ACTION = new JsonEnumWithNameOption("throwerAction", Factory.playerAction);
	...
	JsonEnumWithNameOption TURN_MODE = new JsonEnumWithNameOption("turnMode", Factory.turnMode);
	...
	JsonEnumWithNameOption WIZARD_SPELL = new JsonEnumWithNameOption("wizardSpell", Factory.specialEffect);
