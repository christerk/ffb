...
public interface IJsonOption {
	...
	JsonEnumWithNameOption CONCEDE_GAME_STATUS = new JsonEnumWithNameOption("concedeGameStatus",
			new ConcedeGameStatusFactory());
	...
	JsonEnumWithNameOption PLAYER_CHOICE_MODE = new JsonEnumWithNameOption("playerChoiceMode",
			new PlayerChoiceModeFactory());
	...
	JsonEnumWithNameOption SEND_TO_BOX_REASON = new JsonEnumWithNameOption("sendToBoxReason",
			new SendToBoxReasonFactory());
	...
	JsonEnumWithNameOption SERIOUS_INJURY_DECAY = new JsonEnumWithNameOption("seriousInjuryDecay",
			new SeriousInjuryFactory());
	JsonEnumWithNameOption SERIOUS_INJURY_NEW = new JsonEnumWithNameOption("seriousInjuryNew",
			new SeriousInjuryFactory());
	JsonEnumWithNameOption SERIOUS_INJURY_OLD = new JsonEnumWithNameOption("seriousInjuryOld",
			new SeriousInjuryFactory());
