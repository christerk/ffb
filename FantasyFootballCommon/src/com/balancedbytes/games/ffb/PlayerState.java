...
public class PlayerState {
  ...
  private static int[] _BASE_MASK = new int[] {
    0x0000,  // UNKNOWN
    0xff00,  // STANDING
    0xff00,  // MOVING
    0xff00,  // PRONE
  ...
  public boolean canBeSetUp() {
    return ((STANDING == getBase()) || (MOVING == getBase()) || (PRONE == getBase()) || (STUNNED == getBase()) || (RESERVE == getBase()) || (FALLING == getBase()) || (BLOCKED == getBase()));
  }
  
  public boolean hasTacklezones() {
    return (((STANDING == getBase()) || (MOVING == getBase()) || (BLOCKED == getBase())) && !isConfused() && !isHypnotized());
  }
