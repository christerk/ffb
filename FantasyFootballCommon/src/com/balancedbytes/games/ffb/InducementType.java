...
public enum InducementType implements INamedObject {
	...
	BLOODWEISER_KEGS("bloodweiserBabes", "Bloodweiser Kegs", "Bloodweiser Keg", "Bloodweiser Kegs",
			GameOptionId.INDUCEMENT_KEGS_MAX, GameOptionId.INDUCEMENT_KEGS_COST),
	BRIBES("bribes", "Bribes", "Bribe", "Bribes", GameOptionId.INDUCEMENT_BRIBES_MAX, GameOptionId.INDUCEMENT_BRIBES_COST,
	...
	IGOR("igor", "Igor", "Igor", "Igors", GameOptionId.INDUCEMENT_IGORS_MAX, GameOptionId.INDUCEMENT_IGORS_COST),
	...
	WIZARD("wizard", "Wizard", "Wizard", "Wizards", GameOptionId.INDUCEMENT_WIZARDS_MAX,
	...
	RIOTOUS_ROOKIES("riotousRookies", "Riotous Rookies", "Riotous Rookies", "Riotous Rookies",
