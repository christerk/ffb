...
public enum InducementType implements INamedObject {
  ...
  EXTRA_TEAM_TRAINING("extraTeamTraining", "Extra Training", "Extra Team Training",
    "Extra Team Trainings", GameOptionId.INDUCEMENT_EXTRA_TRAINING_MAX, GameOptionId.INDUCEMENT_EXTRA_TRAINING_COST),
  MASTER_CHEF("halflingMasterChef", "Halfling Master Chef", "Halfling Master Chef",
    "Halfling Master Chefs", GameOptionId.INDUCEMENT_CHEFS_MAX, GameOptionId.INDUCEMENT_CHEFS_COST, GameOptionId.INDUCEMENT_CHEFS_REDUCED_COST),
  ...
  WANDERING_APOTHECARIES("wanderingApothecaries", "Wandering Apo.", "Wandering Apothecary",
    "Wandering Apothecaries", GameOptionId.INDUCEMENT_APOS_MAX, GameOptionId.INDUCEMENT_APOS_COST),
