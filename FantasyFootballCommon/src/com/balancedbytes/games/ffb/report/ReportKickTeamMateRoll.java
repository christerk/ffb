...
public class ReportKickTeamMateRoll implements IReport {
  ...
  public ReportKickTeamMateRoll(String pKickingPlayerId, String pKickedPlayerId, boolean pSuccessful, int[] pRoll, boolean pReRolled, int pKickDistance) {
  ...
  public IReport transform() {
    return new ReportKickTeamMateRoll(getKickingPlayerId(), getKickedPlayerId(), isSuccessful(), getRoll(), isReRolled(), getKickDistance());
  }
