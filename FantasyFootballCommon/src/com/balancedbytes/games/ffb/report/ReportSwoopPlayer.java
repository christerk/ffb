...
public class ReportSwoopPlayer implements IReport {
  ...
  public ReportSwoopPlayer(FieldCoordinate pStartCoordinate, FieldCoordinate pEndCoordinate, Direction[] pDirections, int[] pRolls) {
    this();
  ...
  public IReport transform() {
    return new ReportSwoopPlayer(FieldCoordinate.transform(getStartCoordinate()), FieldCoordinate.transform(getEndCoordinate()), new DirectionFactory().transform(getDirections()), getRolls());
  }
  ...
  public ReportSwoopPlayer initFrom(JsonValue pJsonValue) {
