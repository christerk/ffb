...
public class UtilServerGame {
  ...
  public static void changeActingPlayer(IStep pStep, String pActingPlayerId, PlayerAction pPlayerAction, boolean pLeaping) {
  ...
  protected static void updateLeaderReRollsForTeam(TurnData pTurnData, Team pTeam, FieldModel pFieldModel, IStep pStep) {
  ...
  private static void addApothecaries(IStep pStep, boolean pHomeTeam) {
    ...
    if ((wanderingApothecaries != null) && (wanderingApothecaries.getValue() > 0)) {
      ...
      pStep.getResult().addReport(new ReportInducement(team.getId(), InducementType.WANDERING_APOTHECARIES, wanderingApothecaries.getValue()));
    }
  }
  ...
  private static void addReRolls(IStep pStep, boolean pHomeTeam) {
    ...
    if ((extraTraining != null) && (extraTraining.getValue() > 0)) {
      ...
      pStep.getResult().addReport(new ReportInducement(team.getId(), InducementType.EXTRA_TEAM_TRAINING, extraTraining.getValue()));
    }
  }
