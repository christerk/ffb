  ...
  public static boolean askForReRollIfAvailable(GameState pGameState, Player pPlayer, ReRolledAction pReRolledAction, int pMinimumRoll, boolean pFumble) {
    ...
    if (pMinimumRoll >= 0) {
      ...
      if (reRollAvailable) {
        ...
        UtilDialog.showDialog(pGameState, new DialogReRollParameter(playerId, pReRolledAction, pMinimumRoll, teamReRollOption, proOption, pFumble));
      }
    }
