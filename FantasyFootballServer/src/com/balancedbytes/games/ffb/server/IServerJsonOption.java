...
public interface IServerJsonOption extends IJsonOption {
	...
	JsonEnumWithNameOption APOTHECARY_MODE = new JsonEnumWithNameOption("apothecaryMode", Factory.apothecaryMode);
	JsonEnumWithNameOption APOTHECARY_STATUS = new JsonEnumWithNameOption("apothecaryStatus", Factory.apothecaryStatus);
	...
	JsonEnumWithNameOption CATCH_SCATTER_THROW_IN_MODE = new JsonEnumWithNameOption("catchScatterThrowInMode",
			Factory.catchScatterThrowInMode);
	...
	JsonEnumWithNameOption GAME_STATUS = new JsonEnumWithNameOption("gameStatus", Factory.gameStatus);
	...
	JsonEnumWithNameOption INDUCEMENT_PHASE = new JsonEnumWithNameOption("inducementPhase", Factory.inducementPhase);
	...
	JsonEnumWithNameOption NEXT_ACTION = new JsonEnumWithNameOption("nextAction", Factory.stepAction);
	...
	JsonEnumWithNameOption OLD_TURN_MODE = new JsonEnumWithNameOption("oldTurnMode", Factory.turnMode);
	...
	JsonEnumWithNameOption STEP_ID = new JsonEnumWithNameOption("stepId", Factory.stepId);
