...
public class SequenceGenerator {
  ...
  public void pushBlockSequence(GameState pGameState, String pBlockDefenderId, boolean pUsingStab, String pMultiBlockDefenderId) {
    ...
    add(blockSequence, StepId.APOTHECARY, pGameState, IStepLabel.APOTHECARY_DEFENDER,
        createParameterSet(StepParameterKey.APOTHECARY_MODE, ApothecaryMode.DEFENDER));
    add(blockSequence, StepId.APOTHECARY, pGameState, IStepLabel.APOTHECARY_ATTACKER,
        createParameterSet(StepParameterKey.APOTHECARY_MODE, ApothecaryMode.ATTACKER));
  ...
  public void pushPassSequence(GameState pGameState, FieldCoordinate pTargetCoordinate) {
    ...
    add(passSequence, StepId.HAIL_MARY_PASS, pGameState, IStepLabel.HAIL_MARY_PASS,
        createParameterSet(StepParameterKey.GOTO_LABEL_ON_FAILURE, IStepLabel.SCATTER_BALL));
  ...
  public void pushFoulSequence(GameState pGameState, String pFouldDefenderId) {
    ...
    add(foulSequence, StepId.APOTHECARY, pGameState, IStepLabel.APOTHECARY_ATTACKER,
        createParameterSet(StepParameterKey.APOTHECARY_MODE, ApothecaryMode.ATTACKER));
  ...
  public void pushThrowTeamMateSequence(GameState pGameState, String pThrownPlayerId, FieldCoordinate pTargetCoordinate) {
    ...
    add(throwTeamMateSequence, StepId.APOTHECARY, pGameState, IStepLabel.APOTHECARY_THROWN_PLAYER,
        createParameterSet(StepParameterKey.APOTHECARY_MODE, ApothecaryMode.THROWN_PLAYER));
  ...
  public void pushScatterPlayerSequence(
    ...
    add(scatterPlayerSequence, StepId.APOTHECARY, pGameState, IStepLabel.APOTHECARY_HIT_PLAYER,
        createParameterSet(StepParameterKey.APOTHECARY_MODE, ApothecaryMode.HIT_PLAYER));
  ...
  public void pushMoveSequence(GameState pGameState, FieldCoordinate[] pMoveStack, String pGazeVictimId) {
    ...
    add(moveSequence, StepId.SHADOWING, pGameState); // falling player can be
                                                     // shadowed
