...
public class StepGoForIt extends AbstractStepWithReRoll {
	...
	private void executeStep() {
		...
		boolean goForItAfterBlock = UtilCards.hasSkillWithProperty(actingPlayer.getPlayer(),
	...
	private void succeedGfi() {
		...
		if (actingPlayer.isLeaping()
				&& (actingPlayer.getCurrentMove() > UtilCards.getPlayerMovement(game, actingPlayer.getPlayer()) + 1)
				&& !fSecondGoForIt) {
			fSecondGoForIt = true;
