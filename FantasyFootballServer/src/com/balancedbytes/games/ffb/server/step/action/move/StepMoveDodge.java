...
public class StepMoveDodge extends AbstractStepWithReRoll {
  ...
  private ActionStatus dodge(boolean pDoRoll) {
    ...
    getResult().addReport(new ReportSkillRoll(ReportId.DODGE_ROLL, actingPlayer.getPlayerId(), successful, (pDoRoll ? fDodgeRoll : 0), minimumRoll, dodgeModifierArray, reRolled));
  ...
  public void addTo(ByteList pByteList) {
  	...
  	pByteList.addFieldCoordinate(fCoordinateTo);
  	pByteList.addByte((byte) fDodgeRoll);
  	pByteList.addBoolean(fUsingDivingTackle);
  	pByteList.addBoolean(fUsingBreakTackle);
  }
