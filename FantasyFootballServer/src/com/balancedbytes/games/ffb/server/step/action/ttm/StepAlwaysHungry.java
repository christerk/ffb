...
/**
 * Step in ttm sequence to handle skill ALWAYS_HUNGRY.
 * Failure or success refer to the escape roll of a picked up player.
 * Continues with next step if ALWAYS_HUNGRY roll fails (no attempt to eat player).
 * 
...
public final class StepAlwaysHungry extends AbstractStepWithReRoll {
  ...
  private void executeStep() {
    ...
    boolean doAlwaysHungry = UtilCards.hasUnusedSkill(game, actingPlayer, Skill.ALWAYS_HUNGRY);
  ...
  @Override
  public StepAlwaysHungry initFrom(JsonValue pJsonValue) {
