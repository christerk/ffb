...
public class FumbblResult implements IXmlWriteable {
  ...
  private void addToXml(TransformerHandler pHandler, Team pTeam, InducementSet pInducementSet) {
    ...
    if ((getGame() != null) && (pTeam != null) && (pInducementSet != null)) {
      ...
      if ((inducements.size() > 0) || (starPlayers.size() > 0) || (mercenaries.size() > 0) || ArrayTool.isProvided(cards)) {
        ...
        for (Player mercenary : mercenaries) {
          ...
          UtilXml.addAttribute(attributes, _XML_ATTRIBUTE_ADDED_SKILL, (addedSkill != null) ? addedSkill.getName() : null);
  ...
  private void addToXml(TransformerHandler pHandler, PlayerResult pPlayerResult, Player player) {
    ...
    if ((getGame() != null) && (pPlayerResult != null)) {
      ...
      if (((pPlayerResult.totalEarnedSpps() > 0) || (pPlayerResult.getBlocks() > 0) || (pPlayerResult.getFouls() > 0) || (pPlayerResult.getRushing() != 0) || (pPlayerResult.getPassing() != 0) || (pPlayerResult.getTurnsPlayed() > 0))) {
