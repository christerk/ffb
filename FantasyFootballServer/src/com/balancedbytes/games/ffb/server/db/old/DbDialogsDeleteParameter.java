 ...
 * @author Kalimar
 */
public class DbDialogsDeleteParameter extends DefaultDbUpdateParameter {
  
  private long fGameStateId;
  
  public DbDialogsDeleteParameter(long pGameStateId) {
  ...
  public DbUpdateStatement getDbUpdateStatement(FantasyFootballServer pServer) {
    return (DbUpdateStatement) pServer.getDbUpdateFactory().getStatement(DbStatementId.DIALOGS_DELETE);
  }
