 ...
 * @author Kalimar
 */
public class DbFieldModelsDeleteParameter extends DefaultDbUpdateParameter {
  
  private long fGameStateId;
  
  public DbFieldModelsDeleteParameter(long pGameStateId) {
  ...
  public DbUpdateStatement getDbUpdateStatement(FantasyFootballServer pServer) {
    return (DbUpdateStatement) pServer.getDbUpdateFactory().getStatement(DbStatementId.FIELD_MODELS_DELETE);
  }
