 ...
 * @author Kalimar
 */
public class DbPlayerResultsDeleteParameter extends DefaultDbUpdateParameter {
  
  private long fGameStateId;
  
  public DbPlayerResultsDeleteParameter(long pGameStateId) {
  ...
  public DbUpdateStatement getDbUpdateStatement(FantasyFootballServer pServer) {
    return (DbUpdateStatement) pServer.getDbUpdateFactory().getStatement(DbStatementId.PLAYER_RESULTS_DELETE);
  }
