...
public class StepShadowing extends AbstractStepWithReRoll {
			...
			switch (pReceivedCommand.getId()) {
				case CLIENT_PLAYER_CHOICE:
					...
					if (PlayerChoiceMode.SHADOWING == playerChoiceCommand.getPlayerChoiceMode()) {
						...
						if (StringTool.isProvided(game.getDefenderId()) && game.getDefenderId().equals(playerChoiceCommand.getPlayerId())) {
							state.shadowerWasPreviousDefender = true;
						} else {
	...
	public JsonObject toJsonValue() {
		...
		IServerJsonOption.SHADOWER_WAS_PREVIOUS_DEFENDER.addTo(jsonObject, state.shadowerWasPreviousDefender);
		return jsonObject;
	}
	...
	public StepShadowing initFrom(IFactorySource source, JsonValue jsonValue) {
		...
		state.shadowerWasPreviousDefender = toPrimitive(IServerJsonOption.SHADOWER_WAS_PREVIOUS_DEFENDER.getFrom(source, jsonObject));
		return this;
	}
	...
	public static class StepState {
		...
		public boolean shadowerWasPreviousDefender;
	}
