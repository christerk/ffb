...
public class KickTeamMate extends com.fumbbl.ffb.server.step.generator.KickTeamMate {
	...
	public void pushSequence(SequenceParams params) {
		...
		sequence.add(StepId.GOTO_LABEL, from(StepParameterKey.GOTO_LABEL, IStepLabel.NEXT), from(StepParameterKey.ALTERNATE_GOTO_LABEL, IStepLabel.END_KICK_TEAM_MATE));
		sequence.add(StepId.BONE_HEAD, IStepLabel.NEXT, from(StepParameterKey.GOTO_LABEL_ON_FAILURE, IStepLabel.END_KICK_TEAM_MATE));
