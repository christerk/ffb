...
class InifileParamFilterTest {
    ...
    private static final String INIFIULE_VALUE = "inifile_value";
    ...
    void filterForInifileFiltersExistingParam() {
        String[] input = new String[]{OTHER_PARAM_1, INIFILE_PARAM, INIFIULE_VALUE, OTHER_PARAM_2};
        ...
        assertEquals(INIFIULE_VALUE, result.getInifileName(), "Inifile value has not been extracted correctly");
    }
