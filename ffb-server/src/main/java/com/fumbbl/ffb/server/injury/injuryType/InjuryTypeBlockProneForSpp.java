...
public class InjuryTypeBlockProneForSpp extends ModificationAwareInjuryTypeServer<BlockProneForSpp> {
	public InjuryTypeBlockProneForSpp() {
		super(new BlockProneForSpp());
	}
