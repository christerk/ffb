...
public interface IServerJsonOption extends IJsonOption {
    ...
    JsonBooleanOption ALLOW_MOVE_AFTER_BOMB = new JsonBooleanOption("allowMoveAfterBomb");
    ...
    JsonBooleanOption MODIFIER_CHOICE_MADE = new JsonBooleanOption("modifierChoiceMade");
