...
public class AdminListEntry implements IXmlSerializable {
	...
	public void addToXml(TransformerHandler pHandler) {
		...
		UtilXml.addAttribute(attributes, _XML_ATTRIBUTE_STARTED,
				(getStarted() != null) ? _TIMESTAMP_FORMAT.format(getStarted()) : null);
		UtilXml.addAttribute(attributes, _XML_ATTRIBUTE_FINISHED,
				(getFinished() != null) ? _TIMESTAMP_FORMAT.format(getFinished()) : null);
		UtilXml.addAttribute(attributes, _XML_ATTRIBUTE_LAST_UPDATED,
				(getLastUpdated() != null) ? _TIMESTAMP_FORMAT.format(getLastUpdated()) : null);
