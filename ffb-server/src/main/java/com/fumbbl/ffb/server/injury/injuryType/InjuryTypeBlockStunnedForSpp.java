...
public class InjuryTypeBlockStunnedForSpp extends ModificationAwareInjuryTypeServer<BlockStunnedForSpp > {
	public InjuryTypeBlockStunnedForSpp () {
		super(new BlockStunnedForSpp ());
	}
