...
public abstract class SequenceGenerator<T extends SequenceGenerator.SequenceParams> implements INamedObject {
	...
	public enum Type {
		AutoGazeZoat, BalefulHex, BlitzBlock, BlitzMove, BlackInk, Block, Bomb, CarriedPlayerScatter, CatchOfTheDay,
		Card, EndGame, EndPlayerAction, EndTurn, Foul, FuriousOutburst, IllCarryYou, Inducement, KickTeamMate, Kickoff,
		LookIntoMyEyes, MultiBlock, Move, Pass, PileDriver, Punt,
