	...
	public void prepare(Connection pConnection) {
		try {
			...
			sql.append("SELECT ").append(IDbTableGamesInfo.COLUMN_ID).append(",").append(IDbTableGamesInfo.COLUMN_STARTED)
					...
					.append(IDbTableGamesInfo.COLUMN_TEAM_HOME_NAME).append(",").append(IDbTableGamesInfo.COLUMN_COACH_HOME)
					.append(",").append(IDbTableGamesInfo.COLUMN_TEAM_AWAY_ID).append(",")
					.append(IDbTableGamesInfo.COLUMN_TEAM_AWAY_NAME).append(",").append(IDbTableGamesInfo.COLUMN_COACH_AWAY)
					.append(" FROM ").append(IDbTableGamesInfo.TABLE_NAME).append(" WHERE ")
					.append(IDbTableGamesInfo.COLUMN_FINISHED).append(" IS NULL").append(" AND (")
					.append(IDbTableGamesInfo.COLUMN_COACH_HOME).append("=?").append(" OR ")
					.append(IDbTableGamesInfo.COLUMN_COACH_AWAY).append("=?").append(")");
