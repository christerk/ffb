...
public class StepEjectPlayer extends AbstractStep {
			...
			for (StepParameter parameter : pParameterSet.values()) {
				switch (parameter.getKey()) {
					case GOTO_LABEL_ON_END:
						...
						break;
					case OFFICIOUS_REF:
						state.officiousRef = (boolean) parameter.getValue();
						consume(parameter);
						break;
					default:
						break;
	...
	public JsonObject toJsonValue() {
		...
		IServerJsonOption.OFFICIOUS_REF.addTo(jsonObject, state.officiousRef);
		return jsonObject;
	}
	...
	public StepEjectPlayer initFrom(IFactorySource game, JsonValue pJsonValue) {
		...
		state.officiousRef = toPrimitive(IServerJsonOption.OFFICIOUS_REF.getFrom(game, jsonObject));
		return this;
	}
