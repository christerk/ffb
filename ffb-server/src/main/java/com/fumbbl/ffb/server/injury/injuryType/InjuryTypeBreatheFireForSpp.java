...
public class InjuryTypeBreatheFireForSpp extends ModificationAwareInjuryTypeServer<BreatheFireForSpp> {

	public InjuryTypeBreatheFireForSpp() {
		super(new BreatheFireForSpp());
	}
