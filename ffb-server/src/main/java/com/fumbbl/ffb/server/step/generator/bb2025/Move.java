...
public class Move extends com.fumbbl.ffb.server.step.generator.Move {
	...
	public void pushSequence(SequenceParams params) {
		...
		sequence.add(StepId.JUMP, from(StepParameterKey.MOVE_START, params.getMoveStart()),
			from(StepParameterKey.GOTO_LABEL_ON_FAILURE, IStepLabel.STEADY_FOOTING));
		sequence.add(StepId.STEADY_FOOTING, IStepLabel.STEADY_FOOTING,
			from(StepParameterKey.GOTO_LABEL_ON_FAILURE, IStepLabel.FALL_DOWN));

		sequence.add(StepId.MOVE_DODGE, from(StepParameterKey.GOTO_LABEL_ON_FAILURE, IStepLabel.STEADY_FOOTING));
