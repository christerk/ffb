 ...
 * <li>{@link java.io.Reader} to receive the whole message as a blocking
 * stream</li>
 * <li>any object parameter for which the endpoint has a text decoder
 * ({@link Decoder.Text} or {@link Decoder.TextStream}).</li>
 * </ul>
 * </li>
 ...
 * {@link javax.websocket.server.PathParam} annotation for server
 * endpoints.</li>
 ...
 * 
 * <p>
 * Developers should note that if developer closes the session during the
 ...
 * will be passed back into the endpoint's error handling method.
 *
 * <p>
 * For example:
 * 
...
public @interface OnMessage {
	 ...
	 * incoming whole message exceeds this limit, then the implementation generates
	 * an error and closes the connection using the reason that the message was too
	 * big.
	 *
