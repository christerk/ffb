...
final class DefaultServerEndpointConfig implements ServerEndpointConfig {
	...
	DefaultServerEndpointConfig(Class<?> endpointClass, String path, List<String> subprotocols,
			List<Extension> extensions, List<Class<? extends Encoder>> encoders, List<Class<? extends Decoder>> decoders,
	...
	/**
	 * Return the Encoder implementation classes configured. These will be used by
	 * the container to encode outgoing messages.
	 *
	 * @return the encoder implementation classes, in an unmodifiable list, empty if
	 *         there are none.
	 */
	@Override
	...
	/**
	 * Return the Decoder implementation classes configured. These will be used by
	 * the container to decode incoming messages into the expected custom objects on
	...
	/**
	 * Return the path of this server configuration. The path is a relative URI or
	 * URI-template.
	 *
	 * @return the path
	 */
