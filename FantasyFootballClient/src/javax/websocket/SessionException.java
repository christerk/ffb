...
public class SessionException extends Exception {
	...
	/**
	 * Creates a new instance of this exception with the given message, the wrapped
	 * cause of the exception and the session with which the problem is associated.
	 * 
