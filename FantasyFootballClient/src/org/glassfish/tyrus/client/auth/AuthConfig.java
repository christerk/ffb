 ...
 * <p>
 * An instance of this class can be created by {@link AuthConfig} and it must be
 * registered to property bag in {@link ClientManager}.
 *
...
public class AuthConfig {
	...
	/**
	 * Get an unmodifiable map of authenticators, where case insensitive
	 * authentication scheme to {@link Authenticator}.
	 *
	 * @return unmodifiable map of authenticators. Case insensitive authentication
	 *         scheme is mapped to {@link Authenticator}.
	 */
	...
	/**
	 * Create new {@link Builder} instance, which contains provided Basic and Digest
	 * authenticators.
	 *
	 ...
	 * {@link AuthConfig} for purpose of HTTP Authentication.
	 * <p>
	 * Example 1 - building an authentication configuration enhanced with user
	 * defined NTLM authentication and overridden Basic Authentication:
	 * 
	 * <pre>
	 * <code>
	 ...
	 * </pre>
	 * 
	 * Example 2 - Building an authentication configuration with disabled Basic
	...
	public static final class Builder {
		...
		private final Map<String, Authenticator> authenticators = new TreeMap<String, Authenticator>(
		 ...
		 * <p>
		 * Only one {@link Authenticator} for one authentication scheme can be
		 * registered. If current builder instance already contains
		 * {@link Authenticator} for provided scheme, existing authenticator will be
		 * replaced. Note that schemes are compared in case insensitive manner.
		 *
		 * @param scheme        authentication scheme for which the registered
		 *                      authenticator will be used. Scheme is compared case
		 *                      insensitive.
