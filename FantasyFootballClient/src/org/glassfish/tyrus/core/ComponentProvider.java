 ...
 * <p>
 * Method {@link #isApplicable(Class)} is called first to check whether the
 * provider is able to provide the given {@link Class}. Method
 * {@link #create(Class)} is called to get the instance.
 *
...
public abstract class ComponentProvider {
	/**
	 * Checks whether this component provider is able to provide an instance of
	 * given {@link Class}.
	 *
	 * @param c {@link Class} to be checked.
	 * @return {@code true} iff this {@link ComponentProvider} is able to create an
	 ...
	 * <p>
	 * Useful mainly for EJB container support, where methods from endpoint class
	 * cannot be invoked directly - Tyrus needs to use method declared on remote
	 * interface.
	 * <p>
	 ...
	 * @return <code>true</code> iff the instance was coupled to this
	 *         {@link ComponentProvider}, false otherwise.
	 */
