...
/**
 * Wraps the {@link javax.websocket.RemoteEndpoint} and represents the other
...
public abstract class TyrusRemoteEndpoint implements javax.websocket.RemoteEndpoint {
	...
	static class Async extends TyrusRemoteEndpoint implements javax.websocket.RemoteEndpoint.Async {
		 ...
		 * <p>
		 * IMPORTANT NOTE: There is no need to start new thread here. All writer
		 * operations are by default asynchronous, the only difference between sync and
		 * async writer are that sync send should wait for future.get().
		 *
		 ...
		 * Sends the message asynchronously.
		 * <p>
		 * IMPORTANT NOTE: There is no need to start new thread here. All writer are by
		 * default asynchronous, only difference between sync and async writer are that
		 * sync send should wait for future.get().
		 *
		 * @param message message to be sent
