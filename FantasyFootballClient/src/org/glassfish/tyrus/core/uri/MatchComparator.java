...
class MatchComparator implements Comparator<Match>, Serializable {
	...
	*/
	...
	public int compare(Match m1, Match m2) {
		debugContext.appendTraceMessage(LOGGER, Level.FINER, DebugContext.Type.MESSAGE_IN, "Choosing better match from ",
				m1, " and ", m2);
		...
		if (m1exact) {
			if (m2exact) { // both exact matches, no-one wins
				debugContext.appendTraceMessage(LOGGER, Level.FINER, DebugContext.Type.MESSAGE_IN, "Both ", m1, " and ", m2,
						" are exact matches");
				return 0;
