...
public class MultivaluedHashMap<K, V> extends AbstractMultivaluedMap<K, V> implements Serializable {
	...
	/**
	 * Constructs an empty multivalued hash map with the specified initial capacity
	 * and the default load factor ({@code 0.75}).
	 *
	 ...
	 * {@link MultivaluedMap }. The {@link List} instances holding the values of
