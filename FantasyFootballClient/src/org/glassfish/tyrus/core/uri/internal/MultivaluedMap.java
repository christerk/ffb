...
public interface MultivaluedMap<K, V> extends Map<K, List<V>> {
	...
	/**
	 * Compare the specified map with this map for equality modulo the order of
	 * values for each key. Specifically, the values associated with each key are
	 * compared as if they were ordered lists.
	 *
