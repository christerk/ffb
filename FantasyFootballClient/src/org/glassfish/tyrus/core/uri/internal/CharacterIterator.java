...
/**
 * Iterator which iterates through the input string and returns characters from
 * that string.
 *
...
final class CharacterIterator {
	 ...
	 *
	 * @return True if there is a character which can be retrieved by
	 *         {@link #next()}, false otherwise.
	 */
	...
	/**
	 * Returns next character in the iteration chain and increase the current
	 * position.
	 *
	 * @return Next character.
	 * @throws RuntimeException The method might throw exception when there is no
	 *                          more character to be retrieved.
	 */
	public char next() {
		if (!hasNext()) {
	...
	/**
	 * Returns the next character without increasing the position. The method does
	 * the same as {@link #next()} but the position is not changed by calling this
	 * method.
	 *
	 * @return Next character.
	 */
	...
	/**
	 * Returns the input String on which this {@link CharacterIterator iterator}
	 * operates.
	 *
