...
public abstract class AbstractMultivaluedMap<K, V> implements MultivaluedMap<K, V> {
	 ...
	 * <p>
	 * NOTE: This implementation ignores {@code null} values; A supplied value of
	 * {@code null} is ignored and not added to the purged value list. As a result
	 * of such operation, empty value list would be registered for the supplied key.
	 ...
	 * Overriding implementations may modify this behavior by providing their own
	...
	/**
	 * Define the behavior for adding a {@code null} values to the first position in
	 * the value list.
	 * <p>
	 * Default implementation is a no-op, i.e. the {@code null} values are ignored.
	 * Overriding implementations may modify this behavior by providing their own
	 ...
	 * <p>
	 * NOTE: This implementation ignores {@code null} values; A supplied value of
	 * {@code null} is ignored and not added to the value list. Overriding
	 ...
	 * {@code null}.
	 * <p>
	 * NOTE: This implementation ignores {@code null} values; Any of the supplied
	 * values of {@code null} is ignored and not added to the value list. Overriding
	 * implementations may modify this behavior by redefining the
	 * {@link #addNull(java.util.List)} method.
	 *
	 * @param key       the key.
	 ...
	 * in the supplied value list is ignored and not added to the value list.
	 * Overriding implementations may modify this behavior by redefining the
	 * {@link #addNull(java.util.List)} method.
	 *
	 * @param key       the key.
	 ...
	 * <p>
	 * NOTE: This implementation ignores {@code null} values; A supplied value of
	 * {@code null} is ignored and not added to the purged value list. Overriding
	 * implementations may modify this behavior by redefining the
	 ...
	 * instance is created, registered within the map to hold the values of the key
	 ...
	 * {@inheritDoc }
	 * <p>
	 * This implementation delegates the method call to to the the underlying [key,
	 * multi-value] store.
	 *
	 ...
	 * multi-value] store.
	 *
	 * @return {@code true} if the specified object is equal to the underlying [key,
	 *         multi-value] store, {@code false} otherwise.
	 */
	@Override
