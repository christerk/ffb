...
/**
 * Wrapper of coders storing the coder coder class (and optionally coder
 * instance), return type of the encode / decode method and coder class.
 *
...
public class CoderWrapper<T> extends CoderAdapter implements Decoder, Encoder {
	 ...
	 * @param type       return type provided by the encode / decode method. Cannot
	 *                   be {@code null}.
	 */
	 ...
	 * @param type  return type provided by the encode / decode method. Cannot be
	 *              {@code null}.
	 */
