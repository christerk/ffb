...
public class TurnTimerTask extends TimerTask {
  ...
  public void run() {
    ...
    if ((ClientMode.PLAYER == getClient().getMode())
      && game.isTurnTimeEnabled()
      && !clientData.isTurnTimerStopped()
      && !game.isHomePlaying()
      && !game.isTimeoutPossible()
      && !game.isTimeoutEnforced()
      && (UtilGameOption.getIntOption(game, GameOptionId.TURNTIME) > 0)
