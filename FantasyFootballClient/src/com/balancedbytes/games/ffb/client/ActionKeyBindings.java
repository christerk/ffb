...
public class ActionKeyBindings {
  ...
  private void init() {
    ...
    playerMoves.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(KeyEvent.VK_NUMPAD8, 0), ActionKey.PLAYER_MOVE_NORTH));
    playerMoves.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(KeyEvent.VK_NUMPAD9, 0), ActionKey.PLAYER_MOVE_NORTHEAST));
    playerMoves.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(KeyEvent.VK_NUMPAD6, 0), ActionKey.PLAYER_MOVE_EAST));
    playerMoves.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(KeyEvent.VK_NUMPAD3, 0), ActionKey.PLAYER_MOVE_SOUTHEAST));
    playerMoves.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(KeyEvent.VK_NUMPAD2, 0), ActionKey.PLAYER_MOVE_SOUTH));
    playerMoves.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(KeyEvent.VK_NUMPAD1, 0), ActionKey.PLAYER_MOVE_SOUTHWEST));
    playerMoves.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(KeyEvent.VK_NUMPAD4, 0), ActionKey.PLAYER_MOVE_WEST));
    playerMoves.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(KeyEvent.VK_NUMPAD7, 0), ActionKey.PLAYER_MOVE_NORTHWEST));
    ...
    if (StringTool.isProvided(moveNortheast)) {
      playerMoves.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(moveNortheast), ActionKey.PLAYER_MOVE_NORTHEAST));      
    }
    ...
    if (StringTool.isProvided(moveSoutheast)) {
      playerMoves.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(moveSoutheast), ActionKey.PLAYER_MOVE_SOUTHEAST));
    }
    ...
    if (StringTool.isProvided(moveSouthwest)) {
      playerMoves.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(moveSouthwest), ActionKey.PLAYER_MOVE_SOUTHWEST));
    }
    ...
    if (StringTool.isProvided(moveNorthwest)) {
      playerMoves.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(moveNorthwest), ActionKey.PLAYER_MOVE_NORTHWEST));
    }
    ...
    if (StringTool.isProvided(selectPlayer)) {
      playerSelection.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(selectPlayer), ActionKey.PLAYER_SELECT));
    }
    String cycleRight = getClient().getProperty(IClientProperty.KEY_PLAYER_CYCLE_RIGHT);
    if (StringTool.isProvided(cycleRight)) {
      playerSelection.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(cycleRight), ActionKey.PLAYER_CYCLE_RIGHT));
    }
    String cycleLeft = getClient().getProperty(IClientProperty.KEY_PLAYER_CYCLE_LEFT);
    if (StringTool.isProvided(cycleLeft)) {
      playerSelection.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(cycleLeft), ActionKey.PLAYER_CYCLE_LEFT));
    }
    ...
    if (StringTool.isProvided(actionBlock)) {
      playerActions.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(actionBlock), ActionKey.PLAYER_ACTION_BLOCK));
    }
    String actionBlitz = getClient().getProperty(IClientProperty.KEY_PLAYER_ACTION_BLITZ);
    if (StringTool.isProvided(actionBlitz)) {
      playerActions.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(actionBlitz), ActionKey.PLAYER_ACTION_BLITZ));
    }
    String actionFoul = getClient().getProperty(IClientProperty.KEY_PLAYER_ACTION_FOUL);
    if (StringTool.isProvided(actionFoul)) {
      playerActions.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(actionFoul), ActionKey.PLAYER_ACTION_FOUL));
    }
    String actionMove = getClient().getProperty(IClientProperty.KEY_PLAYER_ACTION_MOVE);
    if (StringTool.isProvided(actionMove)) {
      playerActions.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(actionMove), ActionKey.PLAYER_ACTION_MOVE));
    }
    ...
    if (StringTool.isProvided(actionStandUp)) {
      playerActions.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(actionStandUp), ActionKey.PLAYER_ACTION_STAND_UP));
    }
    ...
    if (StringTool.isProvided(actionHandOver)) {
      playerActions.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(actionHandOver), ActionKey.PLAYER_ACTION_HAND_OVER));
    }
    String actionPass = getClient().getProperty(IClientProperty.KEY_PLAYER_ACTION_PASS);
    if (StringTool.isProvided(actionPass)) {
      playerActions.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(actionPass), ActionKey.PLAYER_ACTION_PASS));
    }
    String actionLeap = getClient().getProperty(IClientProperty.KEY_PLAYER_ACTION_LEAP);
    if (StringTool.isProvided(actionLeap)) {
      playerActions.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(actionLeap), ActionKey.PLAYER_ACTION_LEAP));
    }
    ...
    if (StringTool.isProvided(actionEndMove)) {
      playerActions.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(actionEndMove), ActionKey.PLAYER_ACTION_END_MOVE));
    }
    String actionStab = getClient().getProperty(IClientProperty.KEY_PLAYER_ACTION_STAB);
    if (StringTool.isProvided(actionStab)) {
      playerActions.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(actionStab), ActionKey.PLAYER_ACTION_STAB));
    }
    String actionGaze = getClient().getProperty(IClientProperty.KEY_PLAYER_ACTION_GAZE);
    if (StringTool.isProvided(actionGaze)) {
      playerActions.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(actionGaze), ActionKey.PLAYER_ACTION_GAZE));
    }
    ...
    if (StringTool.isProvided(actionRangeGrid)) {
      playerActions.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(actionRangeGrid), ActionKey.PLAYER_ACTION_RANGE_GRID));
    }
    ...
    if (StringTool.isProvided(actionHailMaryPass)) {
      playerActions.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(actionHailMaryPass), ActionKey.PLAYER_ACTION_HAIL_MARY_PASS));
    }
    ...
    if (StringTool.isProvided(actionMultipleBlock)) {
      playerActions.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(actionMultipleBlock), ActionKey.PLAYER_ACTION_MULTIPLE_BLOCK));
    }
    ...
    if (StringTool.isProvided(illegalProcedure)) {
      turnActions.add(new ActionKeyAction(getClient(), KeyStroke.getKeyStroke(illegalProcedure), ActionKey.TOOLBAR_ILLEGAL_PROCEDURE));
    }
