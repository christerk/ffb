...
public enum ActionKey {
  ...
  PLAYER_SELECT(IClientProperty.KEY_PLAYER_SELECT),
  PLAYER_CYCLE_RIGHT(IClientProperty.KEY_PLAYER_CYCLE_RIGHT),
  ...
  PLAYER_ACTION_LEAP(IClientProperty.KEY_PLAYER_ACTION_LEAP),
  ...
  MENU_SETUP_LOAD(IClientProperty.KEY_MENU_SETUP_LOAD),
  MENU_SETUP_SAVE(IClientProperty.KEY_MENU_SETUP_SAVE),
