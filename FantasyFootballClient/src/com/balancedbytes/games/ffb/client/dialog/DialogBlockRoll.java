...
public class DialogBlockRoll extends Dialog implements ActionListener, KeyListener {
  ...
  public DialogBlockRoll(FantasyFootballClient pClient, DialogBlockRollParameter pDialogParameter) {
    ...
    boolean ownChoice = ((fDialogParameter.getNrOfDice() > 0) || (!fDialogParameter.hasTeamReRollOption() && !fDialogParameter.hasProReRollOption()));
    ...
    if (!ownChoice) {
      ...
      opponentsChoiceLabel.setFont(new Font(opponentsChoiceLabel.getFont().getName(), Font.BOLD, opponentsChoiceLabel.getFont().getSize()));
  ...
  public void keyReleased(KeyEvent pKeyEvent) {
    ...
    switch (pKeyEvent.getKeyCode()) {
      ...
      case KeyEvent.VK_P:
        ...
        break;
      case KeyEvent.VK_N:
        keyHandled = ((getDialogParameter().hasTeamReRollOption() || getDialogParameter().hasProReRollOption()) && (getDialogParameter().getNrOfDice() < 0));
        break;
    }
    if (keyHandled) {
      if (getCloseListener() != null) {
