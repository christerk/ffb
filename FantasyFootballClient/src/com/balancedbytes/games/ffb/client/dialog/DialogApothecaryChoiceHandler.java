  ...
  public void dialogClosed(IDialog pDialog) {
    ...
    if (testDialogHasId(pDialog, DialogId.APOTHECARY_CHOICE)) {
      ...
      if (apothecaryChoiceDialog.isChoiceNewInjury()) {
        getClient().getCommunication().sendApothecaryChoice(fDialogParameter.getPlayerId(), fDialogParameter.getPlayerStateNew(), fDialogParameter.getSeriousInjuryNew());
      } else {
        getClient().getCommunication().sendApothecaryChoice(fDialogParameter.getPlayerId(), fDialogParameter.getPlayerStateOld(), fDialogParameter.getSeriousInjuryOld());
      }
    }
  }
