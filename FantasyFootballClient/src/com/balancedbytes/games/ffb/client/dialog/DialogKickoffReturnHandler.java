...
public class DialogKickoffReturnHandler extends DialogHandler {
  ...
  public void showDialog() {
    ...
    if ((ClientMode.PLAYER == getClient().getMode()) && game.isHomePlaying()) {
      setDialog(new DialogInformation(getClient(), "Use Kick-Off Return Skill", new String[] { "You may move a single player with this single up to 3 squares within your own half." }, DialogInformation.OK_DIALOG, IIconProperty.GAME_REF));
