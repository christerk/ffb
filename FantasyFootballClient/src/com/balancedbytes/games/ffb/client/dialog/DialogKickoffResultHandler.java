...
public class DialogKickoffResultHandler extends DialogHandler {
  ...
  public void showDialog() {
    ...
    if (dialogKickoffResultParameter.getKickoffResult() != null) {
      ...
      if (lines.size() > 0) {
        setDialog(new DialogInformation(getClient(), dialogKickoffResultParameter.getKickoffResult().getTitle(), lines.toArray(new String[lines.size()]), DialogInformation.OK_DIALOG, IIconProperty.GAME_REF));
