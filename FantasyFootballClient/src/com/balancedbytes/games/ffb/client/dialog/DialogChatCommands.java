...
public class DialogChatCommands extends Dialog {
  ...
  private JEditorPane createEditorPane() {
    ...
    if (getClient().getGame().isTesting()) {
      ...
      html.append("</tr>\n");
      html.append("<tr>\n");
      html.append("<td>").append(_FONT_BOLD_OPEN).append("/animation &lt;name&gt &lt;x&gt; &lt;y&gt;").append(_FONT_BOLD_CLOSE).append("</td>\n");
      html.append("<td>").append(_FONT_OPEN).append("plays animation at the given coordinate.").append(_FONT_CLOSE).append("</td>\n");
      html.append("</tr>\n");
      html.append("<tr>\n");
      html.append("<td>").append(_FONT_BOLD_OPEN).append("/animations").append(_FONT_BOLD_CLOSE).append("</td>\n");
      html.append("<td>").append(_FONT_OPEN).append("lists all available animations.").append(_FONT_CLOSE).append("</td>\n");
      html.append("</tr>\n");
      html.append("<tr>\n");
      ...
      html.append("</tr>\n");
      html.append("<tr>\n");
      html.append("<td>").append(_FONT_BOLD_OPEN).append("/pitch &lt;name&gt;").append(_FONT_BOLD_CLOSE).append("</td>\n");
      html.append("<td>").append(_FONT_OPEN).append("changes the pitch (all weather conditions).").append(_FONT_CLOSE).append("</td>\n");
      html.append("</tr>\n");
      html.append("<tr>\n");
      html.append("<td>").append(_FONT_BOLD_OPEN).append("/pitches").append(_FONT_BOLD_CLOSE).append("</td>\n");
      html.append("<td>").append(_FONT_OPEN).append("lists all available pitches.").append(_FONT_CLOSE).append("</td>\n");
      html.append("</tr>\n");
      html.append("<tr>\n");
      ...
      html.append("</tr>\n");
      html.append("<tr>\n");
      html.append("<td>").append(_FONT_BOLD_OPEN).append("/sound &lt;name&gt;").append(_FONT_BOLD_CLOSE).append("</td>\n");
      ...
      html.append("<td>").append(_FONT_OPEN).append("lists all available sounds.").append(_FONT_CLOSE).append("</td>\n");
      html.append("</tr>\n");
      html.append("<tr>\n");
