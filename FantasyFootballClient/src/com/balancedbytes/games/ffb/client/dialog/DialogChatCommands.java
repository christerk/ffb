...
public class DialogChatCommands extends Dialog {
  ...
  private JEditorPane createEditorPane() {
    ...
    html.append(_FONT_SMALL_OPEN).append("(blackbox, crownofsands, fumbblcup, glt, lustrian, ulthuan.dark, ulthuan.light, warpstone, wheelofchaos.final, wheelofchaos.khorne, wheelofchaos.nurgle, wheelofchaos.slaanesh, wheelofchaos.tzeentch)").append(_FONT_CLOSE).append("</td>\n");
    html.append("</tr>\n");
    html.append("<tr>\n");
