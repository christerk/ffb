...
public class UtilClientStateBlocking {
  ...
  public static boolean actionKeyPressed(ClientState pClientState, ActionKey pActionKey, boolean pDoBlitz) {
    ...
    switch (pActionKey) {
      ...
      default:
        ...
        FieldCoordinate moveCoordinate = UtilActionKeys.findMoveCoordinate(pClientState.getClient(), playerPosition, pActionKey);
  ...
  private static void createAndShowStabPopupMenu(ClientState pClientState, Player pPlayer) {
    ...
    JMenuItem stabAction = new JMenuItem("Stab Opponent", new ImageIcon(iconCache.getIconByProperty(IIconProperty.ACTION_STAB)));
    ...
    JMenuItem blockAction = new JMenuItem("Block Opponent", new ImageIcon(iconCache.getIconByProperty(IIconProperty.ACTION_BLOCK)));
