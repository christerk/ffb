...
public class DialogArgueTheCall extends DialogYesOrNoQuestion {
	...
	public DialogArgueTheCall(FantasyFootballClient pClient, Player<?> pPlayer, boolean stayOnPitch) {
		super(pClient, "Argue the call", createMessages(pPlayer, stayOnPitch), null);
	}
	...
	private static String[] createMessages(Player<?> pPlayer, boolean stayOnPitch) {
		String[] messages;
		if (pPlayer != null) {
			messages = new String[3];
			StringBuilder message = new StringBuilder();
			message.append("On a roll of 6 the ref ");
			if (stayOnPitch) {
