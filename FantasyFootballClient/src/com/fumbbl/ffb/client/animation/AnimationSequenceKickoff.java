...
public class AnimationSequenceKickoff implements IAnimationSequence, ActionListener {
	...
	public static AnimationSequenceKickoff createAnimationSequence(Dimension containerDimension, String pIconProperty) {
		return new AnimationSequenceKickoff(containerDimension, new AnimationFrame[]{new AnimationFrame(pIconProperty, 0.5f, 0.3, 100),
