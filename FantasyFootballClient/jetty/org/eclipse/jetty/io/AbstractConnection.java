...
public abstract class AbstractConnection implements Connection
{
    ...
    private final List<Listener> listeners = new CopyOnWriteArrayList<Connection.Listener>();
    private final AtomicReference<State> _state = new AtomicReference<AbstractConnection.State>(State.IDLE);
