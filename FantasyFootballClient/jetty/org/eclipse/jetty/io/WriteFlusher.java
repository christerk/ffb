...
abstract public class WriteFlusher
{
    ...
    private static final EnumMap<StateType, Set<StateType>> __stateTransitions = new EnumMap<WriteFlusher.StateType, Set<StateType>>(StateType.class);
    ...
    private final AtomicReference<State> _state = new AtomicReference<WriteFlusher.State>();
