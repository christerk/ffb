...
public class EventMethod
{
    ...
    public EventMethod(Class<?> pojo, String methodName, Class<?>... paramTypes)
    {
        ...
        {
            LOG.warn("Cannot use method {}({}): {}",methodName,paramTypes,nsme.getMessage());
            this.method = null;
        }
        catch (SecurityException se)
        {
            LOG.warn("Cannot use method {}({}): {}",methodName,paramTypes,se.getMessage());
            this.method = null;
        }
    }
    ...
    public void call(Object obj, Object... args)
    {
        ...
        catch (IllegalAccessException iae)
        {
            ...
            throw new WebSocketException(err,iae);
        }
        ...
        {
            String err = String.format("Cannot call method %s on %s with args: %s",method,pojo,args);
            throw new WebSocketException(err,ite);
        }
    }
