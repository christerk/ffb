 ...
 * {@link WebSocketContainer}.connectToServer(...) when HTTP response status
 * code {@code 503 - Service Unavailable} is received.
 *
...
public class RetryAfterException extends HandshakeException {
	...
	*/
	...
	/**
	 * Get a delay specified in {@value UpgradeResponse#RETRY_AFTER} response header
	 * in seconds.
	 *
	 * @return a delay in seconds or {@code null} when response does not contain
	 *         {@value UpgradeResponse#RETRY_AFTER} or the value cannot be parsed as
	 *         long ot {@code http-date}.
	 */
