...
public final class PathTemplate extends UriTemplate {
	...
	/**
	 * Create a URI path template and encode (percent escape) any characters of the
	 * template that are not valid URI characters. Paths that don't start with a
	 * slash ({@code '/'}) will be automatically prefixed with one.
	 *
	 * @param path the URI path template.
	 */
	...
	/**
	 * Converts the path provided to a slash-leading form, no matter what is
	 * provided.
	 *
	 * @param path the URI path template.
