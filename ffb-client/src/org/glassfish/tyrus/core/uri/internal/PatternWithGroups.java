...
/**
 * A pattern for matching a string against a regular expression and returning
...
public class PatternWithGroups {
	 ...
	 *
	 * @param regex the regular expression. If the expression is {@code null} or an
	 *              empty string then the pattern will only match a {@code null} or
	 *              empty string.
	 ...
	 * Construct a new pattern.
	 *
	 * @param regex        the regular expression. If the expression is {@code null}
	 *                     or an empty string then the pattern will only match a
	 ...
	 * Match against the pattern.
	 * <p>
	 * If a matched then the capturing group values (if any) will be added to a list
	 * passed in as parameter.
	 *
	 * @param cs          the char sequence to match against the template.
	 * @param groupValues the list to add the values of a pattern's capturing groups
	 *                    if matching is successful. The values are added in the
	 *                    same order as the pattern's capturing groups. The list is
	 *                    cleared before values are added.
	 * @return {@code true} if the char sequence matches the pattern, otherwise
	 *         {@code false}.
	 ...
	 *
	 * @param cs          the char sequence to match against the template.
	 * @param groupNames  the list names associated with a pattern's capturing
	 *                    groups. The names MUST be in the same order as the
	 *                    pattern's capturing groups and the size MUST be equal to
	 *                    or less than the number of capturing groups.
	 * @param groupValues the map to add the values of a pattern's capturing groups
	 *                    if matching is successful. A values is put into the map
	 *                    using the group name associated with the capturing group.
	 *                    The map is cleared before values are added.
