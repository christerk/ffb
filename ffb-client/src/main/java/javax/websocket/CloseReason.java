...
public class CloseReason {
	...
	/**
	 * Creates a reason for closing a web socket connection with the given code and
	 * reason phrase.
	 *
	 ...
	 *
	 * @return the reason phrase. If there is no reason phrase, this returns the
	 *         empty string
	 */
	...
	/**
	 * Converts the CloseReason to a debug-friendly string. The exact format is not
	 * defined by the specification and may change in future releases.
	 *
	...
	/**
	 * A marker interface for the close codes. This interface may be implemented by
	 * enumerations that contain web socket close codes, for example enumerations
	 * that contain all the in use close codes as of web socket 1.0, or an
	 * enumeration that contains close codes that are currently reserved for special
	 * use by the web socket specification.
	 */
	...
	/**
	 * An Enumeration of status codes for a web socket close that are defined in the
	 * specification.
	 */
	public enum CloseCodes implements CloseReason.CloseCode {
		...
		/**
		 * Creates a CloseCode from the given int code number. This method throws an
		 * IllegalArgumentException if the int is not one of the
		 *
