...
public interface EndpointEventListener {
	 ...
	 * <p>
	 * Errors that occur either during
	 * {@link javax.websocket.Endpoint#onOpen(javax.websocket.Session, javax.websocket.EndpointConfig)},
	 * {@link javax.websocket.Endpoint#onClose(javax.websocket.Session, javax.websocket.CloseReason)}
	 * and their annotated equivalent or when handling an incoming message, cause
	 * this listener to be called. It corresponds to the event of invocation of
