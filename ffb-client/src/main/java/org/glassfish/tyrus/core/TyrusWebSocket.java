...
public class TyrusWebSocket {
	...
	/**
	 * Create new instance, set {@link ProtocolHandler} and register
	 * {@link TyrusEndpointWrapper}.
	 *
	 ...
	 */
	public TyrusWebSocket(final ProtocolHandler protocolHandler, final TyrusEndpointWrapper endpointWrapper) {
	...
	/**
	 * Convenience method to determine if this {@link TyrusWebSocket} instance is
	 * connected.
	 *
	 * @return {@code true} if the {@link TyrusWebSocket} is connected,
	 ...
	 * <p>
	 * The execution of this method is synchronized using {@link ProtocolHandler}
	 * instance; see TYRUS-385. Prevents multiple invocations, especially from
	 * container/user code.
	 *
	...
	/**
	 * This callback will be invoked when a fragmented binary message has been
	 * received.
	 *
	 * @param frame the binary data received from the remote endpoint.
	 * @param last  flag indicating whether or not the payload received is the final
	...
	/**
	 * This callback will be invoked when a fragmented textual message has been
	 * received.
	 *
	...
	/**
	 * Closes this {@link TyrusWebSocket} using the
	 * {@link javax.websocket.CloseReason}.
	 *
	 ...
	 * @return {@link Future} which could be used to control/check the sending
	 *         completion state.
	 */
	 ...
	 *
	 * @param data    data to be sent.
	 * @param handler {@link SendHandler#onResult(javax.websocket.SendResult)} will
	 *                be called when sending is complete.
	 */
	 ...
	 *
	 * @param data optional payload. Note that payload length is restricted to 125
	 *             bytes or less.
	 * @return {@link Future} which could be used to control/check the sending
	 *         completion state.
	 */
	 ...
	 * Sends a <code>ping</code> frame with the specified payload (if any).
	 * <p>
	 * It may seem odd to send a pong frame, however, RFC-6455 states: "A Pong frame
	 * MAY be sent unsolicited. This serves as a unidirectional heartbeat. A
