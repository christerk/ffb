...
public enum Component {
	...
	CHAT(new Dimension(389, 226), new Dimension(389, 153), new Dimension(260, 343), new Dimension(741, 139), new Dimension(741, 160)),
	...
	BUTTON_BOX(new Dimension(SIDEBAR_WIDTH_L, 22), new Dimension(SIDEBAR_WIDTH_P, 24), new Dimension(SIDEBAR_WIDTH_L, 22), new Dimension(SIDEBAR_WIDTH_L_FS_1920x1080, 33)),
    ...
    PLAYER_SPP_OFFSET(new Dimension(8, 222), new Dimension(10, 245), new Dimension(8, 222), new Dimension(8, 364)),
    PLAYER_SKILL_OFFSET(new Dimension(8, 246), new Dimension(10, 270), new Dimension(8, 246), new Dimension(8, 405)),
    BOX_BUTTON(new Dimension(72, 22), new Dimension(82, 22), new Dimension(72, 22), new Dimension(SIDEBAR_WIDTH_L_FS_1920x1080 / 2, 22)),
    END_TURN_BUTTON(new Dimension(143, 31), new Dimension(163, 34), new Dimension(143, 31), new Dimension(SIDEBAR_WIDTH_L_FS_1920x1080, 45)),
	...
	CLIENT_SIZE(new Dimension(1078, 762), new Dimension(788, 1019), new Dimension(1050, 834), new Dimension(1920, 1080), new Dimension(1920, 1080)),
	...
	BOX_SQUARE(new Dimension(48, 48), new Dimension(55, 55), new Dimension(48, 48), new Dimension(70, 70)),
  ...
  private final Map<ClientLayout, Dimension> dimensions = new HashMap<>();
	...
	Component(Dimension landscape, Dimension portrait, Dimension square, Dimension wide, Dimension wide1920x1080) {
	...
	Component(Dimension landscape, Dimension portrait, Dimension wide, Dimension wide1920x1080) {
		this(landscape, portrait, portrait, wide, wide1920x1080);
	}
