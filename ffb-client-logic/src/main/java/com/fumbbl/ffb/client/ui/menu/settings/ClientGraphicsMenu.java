...
public class ClientGraphicsMenu extends FfbMenu {
    ...
    private JRadioButtonMenuItem swapMarkingGraphicsOffMenuItem;
    private JRadioButtonMenuItem swapMarkingGraphicsOnMenuItem;
    ...
    public boolean refresh() {
        ...
        String swapMarkingGraphicsSetting = client.getProperty(CommonProperty.SETTING_SWAP_MARKING_GRAPHICS);
        swapMarkingGraphicsOffMenuItem.setSelected(true);
        boolean swapMarkingGraphics = IClientPropertyValue.SETTING_SWAP_MARKING_GRAPHICS_ON.equals(swapMarkingGraphicsSetting);
        swapMarkingGraphicsOnMenuItem.setSelected(swapMarkingGraphics);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (source == swapMarkingGraphicsOffMenuItem) {
            client.setProperty(CommonProperty.SETTING_SWAP_MARKING_GRAPHICS, IClientPropertyValue.SETTING_SWAP_MARKING_GRAPHICS_OFF);
            client.saveUserSettings(true);
        }

        if (source == swapMarkingGraphicsOnMenuItem) {
            client.setProperty(CommonProperty.SETTING_SWAP_MARKING_GRAPHICS, IClientPropertyValue.SETTING_SWAP_MARKING_GRAPHICS_ON);
            client.saveUserSettings(true);
        }
    ...
    private void createIconsMenu() {
        ...
        JMenu swapMarkingGraphicsMenu = new JMenu(dimensionProvider, CommonProperty.SETTING_SWAP_MARKING_GRAPHICS);
        fIconsMenu.add(swapMarkingGraphicsMenu);

        ButtonGroup swapMarkingGraphicsGroup = new ButtonGroup();

        swapMarkingGraphicsOffMenuItem = new JRadioButtonMenuItem(dimensionProvider, "Off");
        swapMarkingGraphicsOffMenuItem.addActionListener(this);
        swapMarkingGraphicsGroup.add(swapMarkingGraphicsOffMenuItem);
        swapMarkingGraphicsMenu.add(swapMarkingGraphicsOffMenuItem);

        swapMarkingGraphicsOnMenuItem = new JRadioButtonMenuItem(dimensionProvider, "On");
        swapMarkingGraphicsOnMenuItem.addActionListener(this);
        swapMarkingGraphicsGroup.add(swapMarkingGraphicsOnMenuItem);
        swapMarkingGraphicsMenu.add(swapMarkingGraphicsOnMenuItem);
    }
