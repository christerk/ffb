...
public class DialogAbout extends Dialog {
	...
	private ImageIcon createAboutImageIcon(FantasyFootballClient pClient, DimensionProvider dimensionProvider) {
		...
		drawBold(g2d, dimensionProvider.scale(10), dimensionProvider.scale(y += offsetBoldLine), "Grounds Keepers: Java, Rijssiej, Tussock, BaronBucky, baelnic", dimensionProvider);
