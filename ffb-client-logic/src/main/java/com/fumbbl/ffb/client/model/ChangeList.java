...
public class ChangeList {
	...
	public ChangeList() {
		versions.add(new VersionChangeList("3.4.0")
			.addBugfix("Break Tackle: A still available Break Tackle was not considered when checking if Diving Tackle could fail a successful dodge, prompting for unnecessary rerolls")
