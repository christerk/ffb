...
public class ChangeList {
	...
	public ChangeList() {
		versions.add(new VersionChangeList("3.4.0")
			...
			.addFeature("2025: Optional dodge modifiers like Break Tackle and Consummate Professional are now offered in a dialog that lets you choose between skill combinations and re-rolls instead of being applied automatically. Skills that give the same bonus as a skill that can be used more often are not offered")
			...
			.addImprovement("2025: Move squares now show the roll needed when an adjacent opponent can use Diving Tackle")
			.addBehaviorChange("2025: A dodge re-roll from a skill is no longer used automatically when failing the dodge would get a rock thrown at a team mate that could still score")
