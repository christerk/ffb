...
/**
 * Buffer used for the case when partial messages are received by the
 * {@link MessageHandler.Whole}.
 * <p>
 * For the first received message {@link MessageHandler.Whole#onMessage(Object)}
 * is called within a new executor to allow blocking reading of passed
 * {@link Reader}.
 *
...
class ReaderBuffer {
	 ...
	 * @param last    should be {@code true} iff this is the last part of the
	...
	/**
	 * Set the {@link MessageHandler} that will consume the constructed
	 * {@link java.io.InputStream}.
	 *
	 * @param messageHandler {@link MessageHandler} that will consume the
	 *                       constructed {@link java.io.InputStream}.
	 */
