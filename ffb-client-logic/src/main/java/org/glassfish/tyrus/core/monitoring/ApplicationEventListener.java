...
/**
 * Listens to application-level events that are interesting for monitoring. Only
 * one listener per application can be registered.
 *
...
public interface ApplicationEventListener {
	 ...
	 * <p>
	 * For monitoring in Grizzly server an instance should be passed to the server
	 ...
	 * </pre>
	 * 
	 * For use in servlet container the class name should be passed as a context
