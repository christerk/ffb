...
public class ReflectionHelper {
	 ...
	 * an instance, the at-sign character '<code>@</code>', and the unsigned
	...
	/**
	 * Create a string representation of a method and an instance whose class
	 * implements the method.
	 * <p>
	 * Returns a string consisting of the name of the class of which the object is
	 * an instance, the at-sign character '<code>@</code>', the unsigned hexadecimal
	 * representation of the hash code of the object, the character
	 * '<code>.</code>', the name of the method, the character '<code>(</code>', the
	 * list of method parameters, and the character '<code>)</code>'. In other
	 * words, thos method returns a string equal to the value of: <blockquote>
	 * 
	 * <pre>
	 * o.getClass().getName() + '@' + Integer.toHexString(o.hashCode()) +
	...
	/**
	 * Get privileged exception action to obtain Class from given class name. If run
	 * using security manager, the returned privileged exception action must be
	 ...
	 * @return privileged exception action to obtain the Class. The action could
	 *         throw {@link ClassNotFoundException} or return {@code null} if the
	 *         class cannot be found.
	 * @throws ClassNotFoundException when provided string contains classname of
	 *                                unknown class.
	 ...
	 * @param <T>  class type.
	 * @param name class name.
	 * @param cl   class loader to use, if {@code null} then the defining class
	 *             loader of the calling class will be utilized.
	 * @return privileged exception action to obtain the Class. The action throws
	 *         {@link ClassNotFoundException} or returns {@code null} if the class
	 *         cannot be found.
	 * @throws ClassNotFoundException when provided string contains classname of
	 *                                unknown class.
	 * @see AccessController#doPrivileged(java.security.PrivilegedExceptionAction)
	...
	/**
	 * Get privileged action to obtain context class loader. If run using security
	 * manager, the returned privileged action must be invoked within a doPrivileged
	 * block.
	 *
	 * @return privileged action to obtain the actual context class loader. The
	 *         action could return {@code null} if context class loader has not been
	 *         set.
	 ...
	 *
	 * @param parameterizedType must be an instance of ParameterizedType and have
	 *                          exactly one type argument.
	 * @return the class of the actual type argument. If the type argument is a
	 *         class then the class is returned. If the type argument is a generic
	 *         array type and the generic component type is a class then class of
	 *         the array is returned. if the type argument is a parameterized type
	 *         and it's raw type is a class then that class is returned. If the
	 *         parameterizedType is not an instance of ParameterizedType or contains
	 *         more than one type argument null is returned.
	 * @throws IllegalArgumentException if the single type argument is not of a
	 *                                  class, or a generic array type, or the
	 *                                  generic component type of the generic array
	 *                                  type is not class, or not a parameterized
	...
	/**
	 * Get the parameterized class arguments for a declaring class that declares a
	 * generic interface type.
	 *
	 * @param p the declaring class
	 * @return the parameterized class arguments, or null if the generic interface
	...
	/**
	 * Get the parameterized type arguments for a declaring class that declares a
	 * generic interface type.
	 *
	 * @param p the declaring class
	 * @return the parameterized type arguments, or null if the generic interface
	 *         type is not a parameterized type.
	 */
	 ...
	 *
	 * @param concrete the concrete class than directly or indirectly implements or
	 *                 extends an interface class.
	 ...
	 * <p>
	 * If there exists a public method on the class that has the same name and
	 * parameters as the existing method then that public method is returned.
	 * <p>
	 * Otherwise, if there exists a public method on the class that has the same
	 * name and the same number of parameters as the existing method, and each
	 * generic parameter type, in order, of the public method is equal to the
	 * generic parameter type, in the same order, of the existing method or is an
	 * instance of {@link TypeVariable} then that public method is returned.
	 *
	 ...
	 *
	 * @return an {@link OsgiRegistry} instance or {@code null} if the class cannot
	 *         be instantiated (not in OSGi environment).
	 */
	 ...
	 * @param collector {@link ErrorCollector} which collects the
	 *                  {@link Exception}s.
	 * @param <T>       type.
	 ...
	 *                                accessible.
	 * @throws InstantiationException if this {@code Class} represents an abstract
