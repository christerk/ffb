...
public interface EndpointConfig {
	...
	/**
	 * Return the Encoder implementation classes configured. These will be
	 * instantiated by the container to encode custom objects passed into the send()
	 * methods on remote endpoints.
	 *
	...
	/**
	 * Return the Decoder implementation classes configured. These will be
	 * instantiated by the container to decode incoming messages into the expected
	 * custom objects on {@link MessageHandler.Whole#onMessage(Object)} callbacks.
	 *
