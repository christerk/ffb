...
/**
 * The handshake request represents the web socket defined Http GET request for
...
public interface HandshakeRequest {
	...
	/**
	 * Return the authenticated user or {@code null} if no user is authenticated for
	 * this handshake.
	 *
	 ...
	 * membership can be defined using deployment descriptors of the containing WAR
	 * file, if running in a Java EE web container. If the user has not been
	 * authenticated, the method returns {@code false}.
	 *
	 * @param role the role being checked.
	 * @return whether the authenticated user is in the role, or false if the user
	 ...
	 * started this conversation was part of, if the implementation is part of a
	 * Java EE web container.
	 *
	 * @return the http session or {@code null} if either the websocket
	 *         implementation is not part of a Java EE web container, or there is no
	 *         HttpSession associated with the opening handshake request.
	 */
