...
public interface MessageHandler {
	...
	/**
	 * This kind of handler is notified by the container on arrival of a complete
	 * message. If the message is received in parts, the container buffers it until
	 * it is has been fully received before this method is called.
	 *
	 * <p>
	 ...
	 *
	 * @param <T> The type of the message object that this MessageHandler will
	 *            consume.
	 */
	...
	/**
	 * This kind of handler is notified by the implementation as it becomes ready to
	 * deliver parts of a whole message.
	 *
	 * <p>
	 ...
	 * messages in smaller parts through this API. These schemes may or may not bear
	 * a relationship to the underlying websocket dataframes in which the message is
	 * received off the wire.
	 *
	 * @param <T> The type of the object that represent pieces of the incoming
	...
	interface Partial<T> extends MessageHandler {
		 ...
		 * @param last           flag to indicate if this partialMessage is the last of
		 *                       the whole message being delivered.
		 */
