...
public class DecodeException extends Exception {
	...
	/**
	 * Constructor with the binary data that could not be decoded, and the reason
	 * why it failed to be, and the cause. The buffer may represent the whole
	 * message, or the part of the message most relevant to the decoding error,
	 * depending whether the application is using one of the streaming methods or
	 * not.
	 *
	...
	/**
	 * Constructor with the text data that could not be decoded, and the reason why
	 ...
	 * decoded, and reason why. The buffer may represent the whole message, or the
	 * part of the message most relevant to the decoding error, depending whether
	...
	/**
	 * Constructs a DecodedException with the given encoded string that cannot be
	 * decoded, and reason why. The encoded string may represent the whole message,
	...
	/**
	 * Return the ByteBuffer containing either the whole message, or the partial
	 * message, that could not be decoded, or {@code null} if this exception arose
	 * from a failure to decode a text message.
	 *
	 * @return the binary data not decoded or {@code null} for text message
	 *         failures.
	 */
	 ...
	 * message that could not be decoded, or {@code null} if this exception arose
	 * from a failure to decode a binary message..
	 *
