...
public class BuildIconCache {
  ...
  public static void main(String[] args) {
    if ((args != null) && (args.length > 0)) {
      BuildIconCache collectPlayerIcons = new BuildIconCache();
      try {
      ...
      System.out.println("java com.balancedbytes.games.ffb.tools.BuildIconCache <downloadDirectory>");
    }
  }
